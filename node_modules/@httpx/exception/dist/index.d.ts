 ...
 */
declare const createHttpException: <T extends HttpErrorStatusCodeOrNumber>(statusCode: T, msgOrParams?: string | HttpExceptionParamsFromStatus<T> | undefined) => HttpExceptionFromStatus<T>;
